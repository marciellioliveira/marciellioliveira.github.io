  ...
  <div class="container-fluid" >
    ...
    <div class="form-group"> 
     ...
     <?php 
	  ...
	  $ch = curl_init();
	  curl_setopt($ch, CURLOPT_URL, "http://localhost/www/FarmaWhere/servidorRest.php");
	  ...
	  $data = array('nome' => ''.$nome.'', 'endereco' => ''.$endereco.'', 'telefone' => ''.$telefone.'', 'email' => ''.$email.'');
